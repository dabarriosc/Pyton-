...
async def write_text(FILE_NAME,get):
    ...
    ruta_2 = f"C:\\Users\\danie\\Desktop\\punto_2\\{FILE_NAME}"
...
time.sleep(3)
asyncio.run(write_text("funcion_1",1))
time.sleep(3)
asyncio.run(write_text("funcion_2",2))
time.sleep(3)
asyncio.run(write_text("funcion_3",3))